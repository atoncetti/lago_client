defmodule LagoApiClient.Invoices do
  @moduledoc """
  ...
  """
  @spec create_invoice(LagoApiClient.InvoiceOneOffCreateInput.t(), keyword) ::
          {:ok, LagoApiClient.Invoice.t()} | {:error, LagoApiClient.Error.t()}
  def create_invoice(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {LagoApiClient.Invoices, :create_invoice},
      url: "/invoices",
      body: body,
      method: :post,
      request: [{"application/json", {LagoApiClient.InvoiceOneOffCreateInput, :t}}],
      response: [
        {200, {LagoApiClient.Invoice, :t}},
  ...
  def download_invoice(lago_id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {LagoApiClient.Invoices, :download_invoice},
  ...
  def finalize_invoice(lago_id, opts \\ []) do
    ...
    client.request(%{
      args: [lago_id: lago_id],
      call: {LagoApiClient.Invoices, :finalize_invoice},
  ...
  ## Options
    ...
    * `currency`: Filter invoices by currency in. Possible values ISO 4217 currency codes.
    * `payment_dispute_lost`: Filter invoices with a payment dispute lost. Possible values are `true` or `false`.
    * `invoice_type`: Filter invoices by invoice type. Possible values are `subscription`, `add_on`, `credit`, `one_off` or `advance_charges`

  """
  @spec find_all_invoices(keyword) ::
          {:ok, LagoApiClient.InvoicesPaginated.t()} | {:error, LagoApiClient.Error.t()}
  def find_all_invoices(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {LagoApiClient.Invoices, :find_all_invoices},
      url: "/invoices",
      method: :get,
      query: query,
      response: [
        {200, {LagoApiClient.InvoicesPaginated, :t}},
        {401, {LagoApiClient.ApiErrorUnauthorized, :t}}
      ],
      opts: opts
    })
  ...
  def find_invoice(lago_id, opts \\ []) do
    ...
    client.request(%{
      args: [lago_id: lago_id],
      call: {LagoApiClient.Invoices, :find_invoice},
  ...
  @type invoice_payment_url_200_json_resp :: %{
          __info__: map,
          invoice_payment_details:
            LagoApiClient.InvoicesInvoicePaymentDetails.invoice_payment_url_200_json_resp() | nil
        }
  ...
  """
  @spec invoice_payment_url(String.t(), keyword) :: {:ok, map} | {:error, LagoApiClient.Error.t()}
  def invoice_payment_url(lago_id, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [lago_id: lago_id],
      call: {LagoApiClient.Invoices, :invoice_payment_url},
      url: "/invoices/#{lago_id}/payment_url",
      method: :post,
      response: [
        {200, {LagoApiClient.Invoices, :invoice_payment_url_200_json_resp}},
        {401, {LagoApiClient.ApiErrorUnauthorized, :t}},
        {404, {LagoApiClient.ApiErrorNotFound, :t}},
        {422, {LagoApiClient.ApiErrorUnprocessableEntity, :t}}
      ],
  ...
  def lose_dispute_invoice(lago_id, opts \\ []) do
    ...
    client.request(%{
      args: [lago_id: lago_id],
      call: {LagoApiClient.Invoices, :lose_dispute_invoice},
  ...
  def refresh_invoice(lago_id, opts \\ []) do
    ...
    client.request(%{
      args: [lago_id: lago_id],
      call: {LagoApiClient.Invoices, :refresh_invoice},
  ...
  """
  @spec retry_payment(String.t(), keyword) :: :ok | {:error, LagoApiClient.Error.t()}
  def retry_payment(lago_id, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [lago_id: lago_id],
      call: {LagoApiClient.Invoices, :retry_payment},
  ...
  """
  @spec update_invoice(String.t(), LagoApiClient.InvoiceUpdateInput.t(), keyword) ::
          {:ok, LagoApiClient.Invoice.t()} | {:error, LagoApiClient.Error.t()}
  def update_invoice(lago_id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {LagoApiClient.Invoices, :update_invoice},
      url: "/invoices/#{lago_id}",
      body: body,
      method: :put,
      request: [{"application/json", {LagoApiClient.InvoiceUpdateInput, :t}}],
      response: [
        {200, {LagoApiClient.Invoice, :t}},
        {400, {LagoApiClient.ApiErrorBadRequest, :t}},
        {401, {LagoApiClient.ApiErrorUnauthorized, :t}},
  ...
  def void_invoice(lago_id, opts \\ []) do
    ...
    client.request(%{
      args: [lago_id: lago_id],
      call: {LagoApiClient.Invoices, :void_invoice},
  ...
  def __fields__(:invoice_payment_url_200_json_resp) do
    [
      invoice_payment_details:
        {LagoApiClient.InvoicesInvoicePaymentDetails, :invoice_payment_url_200_json_resp}
    ]
  end
end
