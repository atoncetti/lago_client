defmodule LagoClient.CustomerObject do
  @moduledoc """
  Provides struct and type for a CustomerObject
  """
  ...
  @type t :: %__MODULE__{
          ...
          applicable_timezone: String.t() | nil,
          ...
          integration_customers: [LagoClient.IntegrationCustomer.t()] | nil,
  ...
  def __fields__(:t) do
    [
      ...
      integration_customers: [{LagoClient.IntegrationCustomer, :t}],
      lago_id: {:string, :uuid},
