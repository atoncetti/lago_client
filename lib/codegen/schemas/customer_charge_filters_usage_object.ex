defmodule LagoClient.CustomerChargeFiltersUsageObject do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          units: String.t() | nil,
          values: LagoClient.CustomerChargeFiltersUsageObjectValues.t() | nil
        }
  ...
  def __fields__(:t) do
    [
      ...
      values: {LagoClient.CustomerChargeFiltersUsageObjectValues, :t}
    ]
  end
end
