defmodule LagoClient.OrganizationUpdateInputOrganization do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          billing_configuration: LagoClient.OrganizationBillingConfiguration.t() | nil,
          city: String.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      billing_configuration: {LagoClient.OrganizationBillingConfiguration, :t},
      ...
      webhook_url: {:union, [{:string, :generic}, :null]},
