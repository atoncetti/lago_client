defmodule LagoClient.InvoiceObject do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          __info__: map,
          applied_taxes: [LagoClient.InvoiceAppliedTaxObject.t()] | nil,
          applied_usage_thresholds: [map] | nil,
          billing_period: [LagoClient.BillingPeriodObject.t()] | nil,
          coupons_amount_cents: integer | nil,
          created_at: DateTime.t() | nil,
          credit_notes_amount_cents: integer | nil,
          currency: String.t() | nil,
          customer: LagoClient.CustomerObject.t() | nil,
          fees_amount_cents: integer | nil,
          file_url: String.t() | nil,
          invoice_type: String.t() | nil,
          issuing_date: Date.t() | nil,
          lago_id: String.t() | nil,
          metadata: [LagoClient.InvoiceMetadataObject.t()] | nil,
  ...
  def __fields__(:t) do
    [
      applied_taxes: [{LagoClient.InvoiceAppliedTaxObject, :t}],
      applied_usage_thresholds: {:union, [[:map], :null]},
      billing_period: [{LagoClient.BillingPeriodObject, :t}],
      ...
      customer: {LagoClient.CustomerObject, :t},
      ...
      lago_id: {:string, :uuid},
      metadata: [{LagoClient.InvoiceMetadataObject, :t}],
