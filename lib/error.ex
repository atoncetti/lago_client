defmodule LagoClient.Error do
  ...
  errors returned from the LagoClient API (for example, Not Found errors).
  ...
  meanings:
    ...
    * `:not_found`: A resource or route was not found. Note that LagoClient may return this kind of
  ...
  @typedoc "LagoClient API client error"
  @type t :: %__MODULE__{
          code: integer | nil,
          message: String.t(),
