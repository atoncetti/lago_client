defmodule LagoApiClient.Error do
  @moduledoc """
  ...
  errors returned from the LagoApiClient API (for example, Not Found errors).
  ...
  meanings:
    ...
    * `:not_found`: A resource or route was not found. Note that LagoApiClient may return this kind of
  ...
  @typedoc "LagoApiClient API client error"
  @type t :: %__MODULE__{
          code: integer | nil,
          message: String.t(),
